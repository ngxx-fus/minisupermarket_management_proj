...
public:
    ...
    void setupUi(QDialog *InvoiceManagement)
    {
        ...
        InvoiceManagement->resize(1111, 710);
...
"}  "));
        ...
        TxtBox_PhoneNumber->setGeometry(QRect(200, 140, 281, 31));
        ...
        TxtBox_CustomerName->setGeometry(QRect(200, 90, 281, 31));
        ...
        TxtBox_CustomerID->setGeometry(QRect(200, 40, 281, 31));
        ...
        comboBox_Customer->setGeometry(QRect(200, 180, 141, 31));
        ...
        GrpBoxProduct->setGeometry(QRect(570, 60, 491, 231));
        QFont font2;
        ...
        TxtBox_ProductID->setGeometry(QRect(180, 40, 291, 31));
        ...
        TxtBox_ProductName->setGeometry(QRect(180, 90, 291, 31));
        ...
        TxtBox_Amount->setGeometry(QRect(180, 140, 291, 31));
        Btn_AddItem = new QPushButton(GrpBoxProduct);
        Btn_AddItem->setObjectName("Btn_AddItem");
        Btn_AddItem->setGeometry(QRect(390, 190, 81, 31));
        Btn_Refresh = new QPushButton(GrpBoxProduct);
        Btn_Refresh->setObjectName("Btn_Refresh");
        Btn_Refresh->setGeometry(QRect(290, 190, 81, 31));
        ...
        tableWidgetItem->setGeometry(QRect(40, 310, 1031, 321));
        ...
        Label_Total->setGeometry(QRect(750, 660, 41, 31));
        QFont font5;
        ...
        TxtBox_Total->setGeometry(QRect(810, 650, 141, 41));

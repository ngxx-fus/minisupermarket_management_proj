...
public:
    ...
    void setupUi(QMainWindow *MiniSupermarKetmanagement)
    {
        ...
        MiniSupermarKetmanagement->resize(1000, 700);
        centralwidget = new QWidget(MiniSupermarKetmanagement);
        centralwidget->setObjectName("centralwidget");
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(390, 200, 271, 91));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(390, 310, 271, 91));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(390, 420, 271, 91));
    ...
    void retranslateUi(QMainWindow *MiniSupermarKetmanagement)
    {
        ...
        pushButton->setText(QCoreApplication::translate("MiniSupermarKetmanagement", "Commodites Management", nullptr));
        pushButton_2->setText(QCoreApplication::translate("MiniSupermarKetmanagement", "Customers Management", nullptr));
        pushButton_3->setText(QCoreApplication::translate("MiniSupermarKetmanagement", "Invoices Management", nullptr));
    } // retranslateUi
